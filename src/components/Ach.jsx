...
const Ach = () => {
  ...
  useEffect(()=>{
    fetch('https://script.google.com/macros/s/AKfycbz1bO_qas8t_C263im1VWOeIu1_DCrzE-lfaaZDXTw6FAJNxd6vhp-QHlmnhrmbjzb1Ag/exec').then(response=>response.json()).then(data=>setAch(data.data))
  })
  return (
    <>
    {
