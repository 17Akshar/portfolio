...
const Edu = () => {
  ...
  useEffect(()=>{
    fetch('https://script.google.com/macros/s/AKfycbwIxGCyNYmwMWoPz5rqon8TeSulWIq58szAKbMM7nDC45b9nppfo-ML9b8LwuDa8P3WTw/exec').then(response=>response.json()).then(data=>setEdu(data.data))
  },[])
